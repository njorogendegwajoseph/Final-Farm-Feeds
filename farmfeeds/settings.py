"""
Django settings for farmfeeds project.
...
SECRET_KEY = 'django-insecure-eu*_5o6-*wyt@718oic(%ta-9%4&70emneteja(nmx^utxreds'
...
WSGI_APPLICATION = 'farmfeeds.wsgi.application'
